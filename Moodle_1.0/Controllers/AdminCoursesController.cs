...
namespace Moodle_1._0.Controllers
{
    ...
    {
        private MoodleDb db = new MoodleDb();
        ...
        public ActionResult Create([Bind(Include = "CourseId,CourseName,Description,TeacherId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseId,CourseName,Description,TeacherId")] Course course)
        {
            if (ModelState.IsValid)
            {
